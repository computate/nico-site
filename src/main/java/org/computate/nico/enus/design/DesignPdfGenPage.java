 ...
 * Translate: false
 **/
public class DesignPdfGenPage extends DesignPdfGenPageGen<PageLayout> {
	...
	@Override public void htmlBodyDesignPdfGenPage() {
		...
		if(listPageDesign == null || listPageDesign.size() == 0) {
			...
			{ e("h1").f();
				{ e("a").a("href", "/pdf").a("class", "w3-bar-item w3-btn w3-center w3-block w3-red w3-hover-red ").f();
	...
	public static void htmlSuggestedDesignPdfGenPage(PageLayout p, String id, SearchList<PageDesign> listPageDesign) {
		...
		try {
			...
			if(
					...
					{ p.e("div").a("class", "").f();
						{ p.e("button").a("id", "refreshAllDesignPdfGenPage", id).a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-red ").a("onclick", "patchPageDesignVals([], {}, function() { addGlow($('#refreshAllDesignPdfGenPage", id, "')); }, function() { addError($('#refreshAllDesignPdfGenPage", id, "')); }); ").f();
