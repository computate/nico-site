...
public class DesignDisplayGenPage extends DesignDisplayGenPageGen<PageLayout> {
	...
	@Override public void htmlBodyDesignDisplayGenPage() {
		...
		if(listPageDesign == null || listPageDesign.size() == 0) {
			...
			{ e("h1").f();
				{ e("a").a("href", "/page").a("class", "w3-bar-item w3-btn w3-center w3-block w3-red w3-hover-red ").f();
	...
	public static void htmlSuggestedDesignDisplayGenPage(PageLayout p, String id, SearchList<PageDesign> listPageDesign) {
		...
		try {
			...
			if(
					...
					{ p.e("div").a("class", "").f();
						{ p.e("button").a("id", "refreshAllDesignDisplayGenPage", id).a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-red ").a("onclick", "patchPageDesignVals([], {}, function() { addGlow($('#refreshAllDesignDisplayGenPage", id, "')); }, function() { addError($('#refreshAllDesignDisplayGenPage", id, "')); }); ").f();
