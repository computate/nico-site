 ...
 * Translate: false
 **/
public class PageDesignGenPage extends PageDesignGenPageGen<PageLayout> {
	...
	@Override public void htmlBodyPageDesignGenPage() {
		...
		if(listPageDesign == null || listPageDesign.size() == 0) {
			...
			{ e("h1").f();
				{ e("a").a("href", "/page-design").a("class", "w3-bar-item w3-btn w3-center w3-block w3-red w3-hover-red ").f();
	...
	public static void htmlSuggestedPageDesignGenPage(PageLayout p, String id, SearchList<PageDesign> listPageDesign) {
		...
		try {
			...
			if(
					...
					{ p.e("div").a("class", "").f();
						{ p.e("button").a("id", "refreshAllPageDesignGenPage", id).a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-red ").a("onclick", "patchPageDesignVals([], {}, function() { addGlow($('#refreshAllPageDesignGenPage", id, "')); }, function() { addError($('#refreshAllPageDesignGenPage", id, "')); }); ").f();
