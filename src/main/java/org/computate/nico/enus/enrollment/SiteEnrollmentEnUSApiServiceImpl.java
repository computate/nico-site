...
public class SiteEnrollmentEnUSApiServiceImpl extends SiteEnrollmentEnUSGenApiServiceImpl {
	...
	public SiteEnrollmentEnUSApiServiceImpl(EventBus eventBus, JsonObject config, WorkerExecutor workerExecutor, PgPool pgPool, WebClient webClient, OAuth2Auth oauth2AuthenticationProvider, AuthorizationProvider authorizationProvider, HandlebarsTemplateEngine templateEngine) {
