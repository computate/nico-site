			...
			if(jsonObject != null) {
				...
				for(Integer i = 0; i < entityVars.size(); i++) {
					...
					case "petName":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD
									, Tuple.of(pk, "petName", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
					...
					case "petMedNote":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD
									, Tuple.of(pk, "petMedNote", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
					...
					case "petTrouble":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD
									, Tuple.of(pk, "petTrouble", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
					...
					case "update":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD
									, Tuple.of(pk, "update", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
					...
					case "petAmount":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD
									, Tuple.of(pk, "petAmount", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
				...
				switch(methodName) {
					...
					case "setPetName":
						if(jsonObject.getString(methodName) == null) {
							...
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD
										, Tuple.of(pk, "petName", o2.jsonPetName())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
					...
					case "setPetMedNote":
						if(jsonObject.getString(methodName) == null) {
							...
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD
										, Tuple.of(pk, "petMedNote", o2.jsonPetMedNote())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
					...
					case "setPetTrouble":
						if(jsonObject.getString(methodName) == null) {
							...
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD
										, Tuple.of(pk, "petTrouble", o2.jsonPetTrouble())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
					...
					case "setUpdate":
						if(jsonObject.getBoolean(methodName) == null) {
							...
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD
										, Tuple.of(pk, "update", o2.jsonUpdate())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
					...
					case "setPetAmount":
						if(jsonObject.getString(methodName) == null) {
							...
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD
										, Tuple.of(pk, "petAmount", o2.jsonPetAmount())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
	...
	public void createSitePet(SiteRequestEnUS siteRequest, Handler<AsyncResult<SitePet>> eventHandler) {
		try {
			...
			tx.preparedQuery(
					...
					, Tuple.of(SitePet.class.getCanonicalName(), userId, created.toOffsetDateTime())
					, Collectors.toList()
					, createAsync
			-> {
