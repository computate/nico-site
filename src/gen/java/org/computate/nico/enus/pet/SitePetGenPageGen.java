...
public abstract class SitePetGenPageGen<DEV> extends Object {
	 ...
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.nico.enus.pet.SitePetGenPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:pagination">Find the entity pagination in Solr</a>
	 * <br/>
	...
	protected SitePetGenPage paginationInit() {
	...
	/**	<br/> The entity query
	 *  It is constructed before being initialized with the constructor by default JsonObject(). 
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.nico.enus.pet.SitePetGenPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:query">Find the entity query in Solr</a>
	 * <br/>
	...
	protected SitePetGenPage queryInit() {
	...
	public Object obtainSitePetGenPage(String var) {
		...
		switch(var) {
			...
			case "pagination":
				return oSitePetGenPage.pagination;
			case "query":
				return oSitePetGenPage.query;
			case "promiseAfter":
