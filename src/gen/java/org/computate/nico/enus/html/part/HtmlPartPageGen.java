...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.nico.enus.html.part.HtmlPartPage&fq=classeEtendGen_indexed_boolean:true">Find the class  in Solr. </a>
 * <br/>
 **/
public abstract class HtmlPartPageGen<DEV> extends HtmlPartGenPage {
	...
	public Object defineHtmlPartPage(String var, Object val) {
		switch(var.toLowerCase()) {
			default:
				return super.defineHtmlPartGenPage(var, val);
		}
